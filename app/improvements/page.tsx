      ...
      <section className="border-b bg-white py-16 text-center">
        <div className="mx-auto max-w-6xl px-4 md:px-6">
          ...
          <p className="text-slate-600 max-w-lg mx-auto mb-8 text-lg">
            Checkout isn&apos;t live yet. The published offer is one{" "}
            <strong className="text-blue-600">$29/month training membership</strong>
            {" "}— lessons, assessments, and reporting. Not a managed SOC.
          </p>
