...
const frameworks = [
  ...
  },
  {
    ...
    icon: Radar,
    href: "/frameworks/threat-monitoring",
  ...
  },
  {
    ...
    summary: "When things go wrong, the difference between a survivable incident and a catastrophic one is preparation.",
    quip: "Because hoping for the best is not a response plan.",
  },
  {
    name: "Risk Management",
    icon: TrendingUp,
    href: "/frameworks/risk-management",
    summary: "Understanding, assessing, and treating security risks in business terms that make leadership listen.",
    quip: "Making risk real without making it feel like a horror story.",
  },
]
...
const comparisonRows = [
  ...
  },
  {
    ...
    bestFor: "Organizations that want to survive security events",
    reality: "Because the question is not if, but when. Being ready matters.",
  },
  {
    focus: "Risk Management",
    bestFor: "Leaders who need risk in business terms",
    reality: "Making security relevant to the people who sign the checks.",
  },
]
